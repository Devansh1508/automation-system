  ...
  return (
    <div>
      <div className={`mb-4 gap-4 flex items-center rounded-lg ${
                    leave.leave.approved ? "bg-green-500" : "bg-[#cd1b1bd7]" 
                  }`}>
                <p
                ...
                <span className="relative right-2left-[50%] flex h-3 w-3">
                  <span className={`animate-ping absolute inline-flex h-full w-full rounded-full ${leave.leave.approved ? "bg-green-500" : "bg-[#cd1b1bd7]"} opacity-75`}></span>
                  <span className={`relative inline-flex rounded-full h-3 w-3 ${leave.leave.approved ? "bg-green-500" : "bg-[#cd1b1bd7]"} `}></span>
                </span>
                </div>
              </div>
    </div>
